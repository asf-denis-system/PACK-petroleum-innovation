...
| # | РП | Статус | Описание |
|---|-----|--------|----------|
| SPI-W10-001 | Ревизия `pack/01-domain-contract` после последних правок | done (W13-001, 2026-03-15) | domain-contract v0.3.1 целостен; все ссылки валидны; DRR.005 добавлен 2026-03-10 |
| SPI-W10-002 | Проверить связность индексов и методов в `pack/02-03-*` | done (W13-002, 2026-03-15) | 02D-tools-index расширен до M.013; роли покрывают M.011-013; методы 01-13 согласованы |
| SPI-W10-003 | Обновить операционные шаблоны в `pack/04-work-products` | done (W13-003, 2026-03-15) | Шаблоны 01-07 актуальны; v1.0 для M.011-013; операционный цикл зафиксирован в W11 |
